...
const TransactionForm = (props: {
  ...
  // ✅ Local state for currency + locale
  const [currency, setCurrency] = useState("USD");
  const [locale, setLocale] = useState("en-US");

  useEffect(() => {
    // Detect user’s currency once on mount
    detectCurrency().then(({ currency, locale }) => {
                  ...
                  <FormControl>
                    <div className="relative">
                      <CurrencyInputField
                        ...
                        placeholder={formatCurrency(0, currency, locale)} // ✅ formatted placeholder
                        prefix={
