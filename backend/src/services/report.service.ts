...
export const generateReportService = async (
  ...
  const byCategory = categories.reduce(
    (acc: any, { _id, total }: any) => {
      acc[_id] = {
        amount: convertToRuppeeUnit(total),
        percentage:
  ...
  return {
    period: periodLabel,
    summary: {
      income: convertToRuppeeUnit(totalIncome),
      expenses: convertToRuppeeUnit(totalExpenses),
      balance: convertToRuppeeUnit(availableBalance),
